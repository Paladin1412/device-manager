 ...
 */
public class BigpipeWriterClientGreyImpl implements BigpipeWriterClient {
    ...
    public BigpipeWriterClientGreyImpl(BigpipeGreyConfig config, String pipletname) throws BigpipeException {
